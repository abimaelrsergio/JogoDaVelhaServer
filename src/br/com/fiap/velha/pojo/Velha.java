package br.com.fiap.velha.pojo;
...
public class Velha{
	...
	public void limpar() {
		id = MotorDoJogoDaVelha.JOGADOR_VAZIO;
		status = MotorDoJogoDaVelha.STATUS_AGUARDE;
		jogada = -1;
		for (int pos = 0; pos < tabuleiro.length; pos++) {
			tabuleiro[pos] = MotorDoJogoDaVelha.JOGADOR_VAZIO;
		}
	}
